...
:url-repo: https://github.com/hyperpolymath/asdf-pomerium-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-pomerium-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-pomerium-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-pomerium-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Pomerium] versions.
...
Pomerium is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Pomerium versions per project

|**Project Isolation**
|Pin Pomerium per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Pomerium version
...
=== Installing Pomerium Versions

[source,bash]
----
asdf list all pomerium
asdf install pomerium latest
asdf install pomerium 0.1.0
----
...
[source,bash]
----
asdf global pomerium 0.1.0
asdf local pomerium 0.1.0
asdf current pomerium
pomerium --version
----
...
* Ensure `pomerium` is on PATH after installation.
* Verify the installed version with `pomerium --version`.
