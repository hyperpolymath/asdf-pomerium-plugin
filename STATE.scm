...
;; STATE.scm - Project state tracking for asdf-pomerium-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-pomerium-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-pomerium-plugin")
    (repo "hyperpolymath/asdf-pomerium-plugin"))

  (project-context
    (name "asdf-pomerium-plugin")
